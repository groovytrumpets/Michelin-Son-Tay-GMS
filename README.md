...
| :---: | :--- | :--- | :--- | :---: |
| <img src="[https://github.com/github.png](https://avatars.githubusercontent.com/u/166611562?v=4)" width="45" height="45" style="border-radius:50%;"/> | **Nguyễn Nam Khánh** | **Team Leader**<br>Backend Engineer | Architecture design (Clean Architecture, DDD), core API developments, dynamic pricing & tax recalculation logic. | [![GitHub](https://img.shields.io/badge/-Profile-181717?style=flat&logo=github)](https://github.com/groovytrumpets) |
...
| <img src="[https://github.com/github.png](https://avatars.githubusercontent.com/u/211706548?v=4)" width="45" height="45" style="border-radius:50%;"/> | **Le Trong Tan** | DevOps & System | Dockerization, Linux environment setup, deployment, Hikvision camera hardware integration, system security. | [![GitHub](https://img.shields.io/badge/-Profile-181717?style=flat&logo=github)](https://github.com/tanle04) |
